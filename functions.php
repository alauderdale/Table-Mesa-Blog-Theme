...
function boiler_scripts_styles() {
	...
	wp_enqueue_script( 'viewportchecker', get_template_directory_uri() . '/js/vendor/jquery.viewportchecker.js', '20120206', true );
	...
	// wp_enqueue_script( 'class', get_template_directory_uri() . '/js/vendor/classie.js', '20120206', true );
